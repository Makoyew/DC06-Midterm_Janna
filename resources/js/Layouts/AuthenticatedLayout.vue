                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="relative inline-flex items-center ml-3">
                                <div class="relative m-5" @click="darkTheme = !darkTheme">
                                    <div class="w-10 h-5 bg-gray-200 rounded-full shadow-inner">
                                    <div
                                        :class="[
                                        darkTheme ? 'text-black' : 'text-yellow-300',
                                        'w-5 h-5 rounded-full shadow-md transform duration-200 ease-in-out flex items-center justify-center',
                                        ]"
                                        :style="{ transform: darkTheme ? 'translateX(100%)' : 'translateX(0)' }"
                                    >
                                        <i :class="darkTheme ? 'fas fa-moon' : 'fas fa-sun'"></i>
                                    </div>
                                    </div>
                                </div>
